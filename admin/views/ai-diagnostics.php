<?php
/**
 * AI diagnostics — embeddable panel partial.
 *
 * Rendered inside the "Stato sistema" page under the "Diagnostica AI" tab.
 * Expects $report, $test_result and $connectivity_result in scope.
 *
...
?>
<div class="wpai-ai-diagnostics">
	<p class="wpai-tab-intro"><?php echo esc_html__( 'Aiuta a capire come il sistema AI di WordPress espone connector, abilities, funzioni e route REST. Non mostra chiavi segrete e non esegue chiamate remote se non tramite i test manuali qui sotto.', 'wp-ai-publisher' ); ?></p>

	<div class="wpai-section">
		<h2><?php echo esc_html__( 'Riepilogo', 'wp-ai-publisher' ); ?></h2>
	...
	<div class="wpai-section">
		<h2><?php echo esc_html__( 'Test interattivi', 'wp-ai-publisher' ); ?></h2>

		<h3><?php echo esc_html__( 'Test AI controllato', 'wp-ai-publisher' ); ?></h3>
		...
		<h3><?php echo esc_html__( 'Verifica connettività OpenAI', 'wp-ai-publisher' ); ?></h3>
	...
	<div class="wpai-section">
		<h2><?php echo esc_html__( 'Percorsi di generazione possibili', 'wp-ai-publisher' ); ?></h2>
		<table class="widefat striped wpai-status-table">
	...
	<div class="wpai-section">
		<h2><?php echo esc_html__( 'Bridge manuale consigliato', 'wp-ai-publisher' ); ?></h2>
	...
	<div class="wpai-section">
		<h2><?php echo esc_html__( 'Inventario tecnico rilevato', 'wp-ai-publisher' ); ?></h2>
		<p class="wpai-tab-intro"><?php echo esc_html__( 'Dati di sola lettura raccolti dall’ambiente. Espandi le sezioni per il dettaglio.', 'wp-ai-publisher' ); ?></p>

		<details class="wpai-diag-group">
			<summary><?php echo esc_html__( 'Funzioni rilevate', 'wp-ai-publisher' ); ?> (<?php echo esc_html( (string) count( (array) $report['functions'] ) ); ?>)</summary>
			<table class="widefat striped wpai-status-table">
		...
		<details class="wpai-diag-group">
			<summary><?php echo esc_html__( 'Classi rilevate', 'wp-ai-publisher' ); ?> (<?php echo esc_html( (string) count( (array) $report['classes'] ) ); ?>)</summary>
			<table class="widefat striped wpai-status-table">
		...
		<details class="wpai-diag-group">
			<summary><?php echo esc_html__( 'REST route AI', 'wp-ai-publisher' ); ?> (<?php echo esc_html( (string) count( (array) $report['rest_routes'] ) ); ?>)</summary>
		...
		<details class="wpai-diag-group">
			<summary><?php echo esc_html__( 'Opzioni AI rilevate, mascherate', 'wp-ai-publisher' ); ?> (<?php echo esc_html( (string) count( (array) $report['options'] ) ); ?>)</summary>
		...
		<details class="wpai-diag-group">
			<summary><?php echo esc_html__( 'Abilities WordPress rilevate', 'wp-ai-publisher' ); ?> (<?php echo esc_html( (string) count( (array) $report['abilities'] ) ); ?>)</summary>
  ...
  3
		...
		<details class="wpai-diag-group">
			<summary><?php echo esc_html__( 'Plugin AI rilevati', 'wp-ai-publisher' ); ?> (<?php echo esc_html( (string) count( (array) $report['plugins'] ) ); ?>)</summary>
		...
		<details class="wpai-diag-group">
			<summary><?php echo esc_html__( 'Esperimenti AI rilevati', 'wp-ai-publisher' ); ?> (<?php echo esc_html( (string) count( (array) $report['experiments'] ) ); ?>)</summary>
			<table class="widefat striped wpai-status-table">
